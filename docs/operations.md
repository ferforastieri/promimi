...
O app Android é gerado como APK quando `MOBILE_SITE_URL` estiver cadastrada como variável pública do repositório. O valor deve ser a URL HTTPS pública do site; não use `localhost` ou a URL interna da API. Após um deploy de API, valide `GET /health`, o site e o login com cookie.
