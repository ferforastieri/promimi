...
export const communityRepository = {
  commentsForOffer: (offerId: string) => db.query.comments.findMany({ where: and(eq(comments.offerId, offerId), eq(comments.isHidden, false)), with: { user: true }, orderBy: [desc(comments.createdAt)] }),
